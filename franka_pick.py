...
class FrankaRope(BaseSample):
    ...
    async def _on_replay_recording_event_async(self, data_file,callback_fn=None):
        ...
        world.add_physics_callback("replay_recording", partial(self._on_replay_cube_recording_step,time_offset=world.current_time_step_index))
    ...
    def _on_replay_cube_recording_step(self, step_size, time_offset=0):
        world=self._world
        data_logger=self._data_logger
        cube=self._cube
