...
from equibot.policies.vision.pfc_sim3_encoder import PfcSIM3Vec4Latent
...
class PfcEquiBotPolicy(nn.Module):
    def __init__(self, cfg, device="cpu"):
        ...
        if self.obs_mode.startswith("pc"):
            self.encoder = PfcSIM3Vec4Latent(**cfg.model.encoder)
        else:
            self.encoder = None
