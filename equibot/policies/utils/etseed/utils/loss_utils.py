...
def compute_loss(T1, T2,pred_gripper=None,gt_gripper=None,sign_mismatch=True,snr=None,gt_gripper_zero_one=True):
    ...
    #     print(pred_gripper.shape,dist_g_square.shape,"FSDFSDF")
